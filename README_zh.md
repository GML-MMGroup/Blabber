...
<div align="center">
  <!-- 产品宣传片占位：后续将以下封面图替换为正式宣传视频。 -->
  <img src="./assets/demo/final-studio-preview.jpg" alt="产品宣传片占位图" width="90%" />
  <p><em>此处保留产品宣传片位置，后续将替换为正式宣传视频。</em></p>
</div>
...
| 🧚 童话故事 | 🚗 新款汽车 | 💻 科技闲聊 |
|:---:|:---:|:---:|
| ![童话故事](./assets/showcase/fairy-tale.gif) | ![新款汽车](./assets/showcase/new-car.gif) | ![科技闲聊](./assets/showcase/tech-talk.gif) |

| 🎬 电影评论 | 📚 读书分享 | 🏀 体育侃谈 |
|:---:|:---:|:---:|
| ![电影评论](./assets/showcase/movie-review.gif) | ![读书分享](./assets/showcase/book-club.gif) | ![体育侃谈](./assets/showcase/sports-banter.gif) |
...
### 7. 🗂️ 内置发布素材库
- **12 个视频角色** — 嘎嘎、阿汪，以及卡通、Luna、Milo、动漫、扁平科技、低多边形主持人
- **9 个场景** — 动物园、播客间、图书馆、海滨、太空、茶室、霓虹动漫、扁平科技、低多边形
